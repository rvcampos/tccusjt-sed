...
function validaEmailForm()
{
	...
	return true;
		...
		<form class="form-horizontal" action="${app_context}admin/esqueciminhasenha" method="post" id="formAdmin">
			<legend>
		...
		<div class="row-fluid">
				...
				<div class="span2">
					<input class="btn btn-primary" value="Enviar" type="button" name="btnSalvar" onclick="if(validaEmailForm()){$('#formAdmin').submit();}"/>
				</div>
