...
<body>
	...
	<div>
		...
		<input type="hidden" name="hr_init" id="hr_init" value="${hr_init}">
		<input type="hidden" name="hr_end" id="hr_end" value="${hr_end}">
	</div>
	<div id=box></div>
	<div id=pubnub pub-key=demo sub-key=demo></div>
	<script charset="UTF-8" src="${app_context}js/pubnub-3.3.js"></script>
	<script>
	    function validaData()
	    {
