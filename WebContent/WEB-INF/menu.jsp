...
<div class="navbar-inner">
	<div class="container">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-book"></i>Cursos<b class="caret"></b></a>
			<ul class="dropdown-menu">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td valign="top">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i>Conta<b class="caret"></b></a>
			<ul class="dropdown-menu">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td valign="top">
