...
public class SendMail {
     ...
     * @throws MessagingException
     */
    public static void enviarEmail(String subject, String message, String recipient) throws MessagingException {
        try {
            ...
            email.setFrom(Utils.getSendEmail());
            email.setPassword(Utils.getSendPass());
            email.setSmtp(Utils.getSmtp());
            email.setSmtpPort(Utils.getSmtpPort());
            email.setUser(Utils.getSendEmail());

            email.send();
        }
        catch (Exception e) {
            throw new MessagingException("Falha ao enviar e-mail", e);
        }
    }
}
